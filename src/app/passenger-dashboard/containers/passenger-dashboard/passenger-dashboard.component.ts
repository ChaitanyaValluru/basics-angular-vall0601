...
export class PassengerDashboardComponent implements OnInit{
  ...
  ngOnInit(){
    ...
    this.passengerService.getPassengers().subscribe((data: Passenger[]) => this.passengers = data, error => console.log);
    // this.passengerService.getPassengersPromise().then((data: Passenger[]) => this.passengers = data);
  }
